classdef DayData < matlab.mixin.Copyable
    ...
    methods
        function [ dayData ] = DayData( dateString )
            ...
            onlyDate = strcat(dateString(2:5),'-',dateString(6:7),'-',dateString(8:9))     
            ...
            dayData.addInstrument( Bond( T, 0, 1, 1,Inf,Inf ));
            %dayData.addInstrument( Bond( T, 0.03, 1, 1,Inf,Inf ));
...
%             dayData.addInstrument( Bond( T, r, 1, 1,Inf,0 ));
        ...
        function daysToExpiry = getDaysToExpiry(o)
            ...
            expiryDateNum = datenum('17-Febuary-2017');
