...
%                 disp('---------------------------------------------')
            ...
            %if (  exitFlag <= 0)
                ...
                [p,quantities] = lineSearch( @toSolve, guess, o.tolerance);
            %else
            %    p = negP;
            %end
        end                
        ...
        function setModel( o, model, guassianQuadrature ) 
...
%                 guassianQuadrature
                ...
                x = quadRule.x;
                lp = log(quadRule.weights) + model.logProb(x);
                o.setQuadRule( x, lp );
%             else
%                 guassianQuadrature
