classdef UtilityMaximizationSolver < handle
    ...
    methods
        ...
        function o = selectScenariosAndInstruments(o)
            ...
            o.sepProblem = SeparableProblem(o.nq + 2*o.nP);
...
%             c=temp{2}.quantity
%             d=temp{3}.quantity
            o.sepProblem.addLinearUpperBound(vec,b,'Cost constraint');

        end    
        
        function addPositiveQuantityConstraint(o)
            
            A = horzcat(eye(o.nq), zeros(o.nq, o.nP),zeros(o.nq, o.nP));
            b = zeros(o.nq,1);
        ...
        function computeObjectiveFunction(o)
            ...
            c = zeros( o.nq + 2*o.nP, 1 );
            opr = repmat( name, o.nP, 1 );
            oprj = o.nq + o.nP + (1:o.nP)';
